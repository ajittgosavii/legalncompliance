...
You work for the Company, one of the largest utilities in the United States.
...
the Company's compliance priorities:
...
5. Map obligations to Company departments
...
2. Identify which Company departments, systems, and processes are affected
...
1. Analyze historical CPUC/FERC enforcement cases involving the Company and peer utilities
